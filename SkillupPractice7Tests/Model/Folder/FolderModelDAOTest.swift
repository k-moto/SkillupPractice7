...
class FolderModelDAOTest: XCTestCase {
    ...
    func testAdd(){
        ...
        FolderModelDAO.add(model:object)
    ...
    func testUpdate(){
        ...
        FolderModelDAO.update(model:object)
    ...
    func testFindByID(){
        ...
        let result = FolderModelDAO.findByID(id: 1)
    ...
    func testFindAll(){
        ...
        let tasks = [FolderModel(),FolderModel(),FolderModel()]
        
        _ = tasks.map {
            FolderModelDAO.add(model:$0)
        }
    ...
    private func verifyItem(id: Int, title: String, createDateStr: String, updateDateStr: String) {
        ...
        let result = FolderModelDAO.findAll()
